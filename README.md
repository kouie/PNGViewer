...
2023 年あたりの WebUI (AUTOMATIC1111 版) で生成した画像も OK ですが、最近めのバージョンは確認していません。
...
詳細については、「[コレクションウィンドウ]()」のセクションを参照してください。
...
たとえば、インペイント作業中に目に付いた画像をマークしておきたいときや、[比較] タブで 3 枚以上の画像を見比べたい場合など、一時的なストック場所として利用できます。
